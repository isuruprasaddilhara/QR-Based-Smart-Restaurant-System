...
# Backend/scan2serve/menu/serializers.py
...
class MenuSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'availability', 'image', 'image_url', 'ingredients',
        ]
        read_only_fields = ['id', 'image_url']
    ...
    # REMOVED validate_ingredients — ingredients is optional.
    # An empty string is perfectly valid; the frontend textarea can be left blank.
